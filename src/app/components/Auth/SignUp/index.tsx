      ...
      <form onSubmit={handleSubmit}>
        <div className='mb-[22px]'>
          <input
            ...
            name='name'
            required
            className='w-full rounded-md border border-dark_border/60 border-solid bg-transparent px-5 py-3 text-base text-dark outline-hidden transition border-darkmode placeholder:text-darkmode focus:border-darkmode focus-visible:shadow-none text-darkmode'
          />
        </div>
        <div className='mb-[22px]'>
          <input
