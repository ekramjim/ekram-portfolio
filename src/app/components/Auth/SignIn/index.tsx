      ...
      <form onSubmit={(e) => e.preventDefault()}>
        <div className='mb-[22px]'>
          <input
            ...
            className='w-full rounded-md border border-dark_border/60 border-solid bg-transparent px-5 py-3 border-darkmode text-base text-dark outline-hidden transition placeholder:text-darkmode focus:border-darkmode focus-visible:shadow-none text-darkmode'
          />
        </div>
        <div className='mb-[22px]'>
          <input
